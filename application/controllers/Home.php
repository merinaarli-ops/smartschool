...
class Home extends Frontend_Controller
{
    ...
    public function video()
    {
        ...
        $this->data['branchID'] = $branchID;
        $this->data['page_data'] = $this->home_model->get('front_cms_faq', array('branch_id' => $branchID), true);
        $this->data['main_contents'] = $this->load->view('home/video', $this->data, true);
        $this->load->view('home/layout/index', $this->data);
    }
    ...
    public function sovapoti()
    {
        ...
        $this->data['page_data'] = $this->home_model->get('front_cms_home_seo', array('branch_id' => $branchID), true);
        $this->data['main_contents'] = $this->load->view('home/index', $this->data, true);
        $this->data['main_contents'] = $this->load->view('home/sovapoti', $this->data, true);
        $this->load->view('home/layout/index', $this->data);
    }
    ...
    public function privacy()
    {
        ...
        $this->data['page_data'] = $this->home_model->get('front_cms_home_seo', array('branch_id' => $branchID), true);
        $this->data['main_contents'] = $this->load->view('home/index', $this->data, true);
        $this->data['main_contents'] = $this->load->view('home/privacy', $this->data, true);
        $this->load->view('home/layout/index', $this->data);
    }
    ...
    public function terms()
    {
        ...
        $this->data['page_data'] = $this->home_model->get('front_cms_home_seo', array('branch_id' => $branchID), true);
        $this->data['main_contents'] = $this->load->view('home/index', $this->data, true);
        $this->data['main_contents'] = $this->load->view('home/terms', $this->data, true);
        $this->load->view('home/layout/index', $this->data);
    }
    ...
    public function principal()
    {
        ...
        $this->data['page_data'] = $this->home_model->get('front_cms_home_seo', array('branch_id' => $branchID), true);
        $this->data['main_contents'] = $this->load->view('home/index', $this->data, true);
        $this->data['main_contents'] = $this->load->view('home/principal', $this->data, true);
        $this->load->view('home/layout/index', $this->data);
    }
    ...
    public function examResultsPrintFn()
    {
        ...
        if ($_POST) {
            $this->form_validation->set_rules('exam_id', translate('exam'), 'trim|required');
            $this->form_validation->set_rules('academic_year_id', translate('academic_year'), 'trim|required');
            ...
            if ($this->form_validation->run() == true) {
                $sessionID = $this->input->post('academic_year_id');
                ...
                $this->db->where('enroll.roll', $roll);
                ...
                if (empty($userID)) {
                    $array = array('status' => '0', 'error' => "Roll Number Not Found For Selected Class & Section.");
                    echo json_encode($array);
                    exit();
                }
    ...
    {
        // P4.4 Security: This public endpoint is used by the login page branch selector
        // on the apex site (no host-pinning). It returns only a public URL alias,
        // so information disclosure risk is low. We cast to int to prevent injection.
        $branch_id = (int) $this->input->post("branch_id");
        if ($branch_id <= 0) {
            echo json_encode(array('url_alias' => ''));
            return;
        }
