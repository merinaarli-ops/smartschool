...
|
*/
$config['encryption_key'] = 'CHANGE_ME_TO_A_RANDOM_32_CHAR_KEY';
...
|--------------------------------------------------------------------------
| When TRUE, even super-admins (role_id=1) must visit a tenant from a host
| that resolves to their currently selected branch. Default FALSE so super-
| admins can keep using https://smartschool.bd/admin/<branch_alias>/...
| URLs to administer any tenant.
*/
$config['strict_subdomain_isolation'] = FALSE;
