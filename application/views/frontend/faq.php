	...
	<div class="tabs-custom">
		<ul class="nav nav-tabs">
			<li class="<?php echo (!isset($validation_error) ? 'active' : ''); ?>">
				<a href="#list" data-toggle="tab"><i class="fas fa-list-ul"></i> <?php echo translate('Video_Gallery') . " " . translate('list'); ?></a>
			</li>
	<?php if (get_permission('frontend_faq', 'is_add')) { ?>
			<li class="<?php echo (isset($validation_error) ? 'active' : ''); ?>">
				<a href="#create" data-toggle="tab"><i class="far fa-edit"></i> <?php echo translate('add_Video') . " " . translate('Gallery'); ?></a>
			</li>
	<?php } ?>
		</ul>
					...
					<div class="form-group">
						...
						<div class="col-md-7">
							...
							<span class="error"></span>
										...
										<div class="form-group">
						<label class="col-md-3 control-label"><?php echo translate('URL_Embed_Link'); ?> <span class="required">*</span></label>
						<div class="col-md-7">
