<section class="panel">
	<div class="tabs-custom">
		<ul class="nav nav-tabs">
			<li>
				<a href="<?php echo base_url('frontend/faq'); ?>"><i class="fas fa-list-ul"></i> <?php echo translate('Video_Gallery') . " " . translate('list'); ?></a>
			</li>
			<li class="active">
				<a href="#edit" data-toggle="tab"><i class="far fa-edit"></i> <?php echo translate('edit') . " " . translate('Video_Gallery'); ?></a>
			</li>
		</ul>
					...
					<div class="form-group">
						...
						<div class="col-md-7">
							...
							<span class="error"></span>
										...
										<div class="form-group">
						<label class="col-md-3 control-label"><?php echo translate('Youtube_Video_Embed_Link'); ?> <span class="required">*</span></label>
						<div class="col-md-7">
							<input type="text" class="form-control" name="description" value="<?php echo $faq['description']?>" />
							<span class="error"></span>
						</div>
					</div>
