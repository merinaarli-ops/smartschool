<section class="panel">
	<div class="tabs-custom">
		<ul class="nav nav-tabs">
			<li>
				<a href="<?php echo base_url('frontend/news/index'); ?>"><i class="fas fa-list-ul"></i> <?php echo translate('Notice') . " " . translate('list'); ?></a>
			</li>
			<li class="active">
				<a href="#edit" data-toggle="tab"><i class="far fa-edit"></i> <?php echo translate('edit_Notice') . " " . translate('news'); ?></a>
			</li>
		</ul>
