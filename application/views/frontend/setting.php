...
<?php endif; if (!empty($branch_id)): ?>
					...
					<div class="form-group" id="recaptcha_secret_key">
						...
						<div class="col-md-6">
							...
							<span class="error"><?php echo form_error('recaptcha_secret_key'); ?></span>
															...
															<div class="form-group">
						<label class="col-md-3 control-label"><?php echo translate('main_logo'); ?> <span class="required">*</span></label>
						<div class="col-md-6">
							<input type="file" name="main_logo" class="dropify" data-height="90" data-allowed-file-extensions="png jpg jpeg" data-default-file="<?php echo base_url('uploads/frontend/images/' . $setting['main_logo']); ?>" />
							<span class="error"><?php echo form_error('main_logo'); ?></span>
						</div>
					</div>
															...
															<div class="form-group">
						<label class="col-md-3 control-label"><?php echo translate('Mobile_Logo'); ?> <span class="required">*</span></label>
						<div class="col-md-6">
							<input type="file" name="mobile_logo" class="dropify" data-height="90" data-allowed-file-extensions="png jpg jpeg" data-default-file="<?php echo base_url('uploads/frontend/images/' . $setting['mobile_logo']); ?>" />
							<span class="error"><?php echo form_error('mobile_logo'); ?></span>
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-md-6">
							...
							<span class="error"><?php echo form_error('fav_icon'); ?></span>
															...
															<div class="form-group">
						<label class="col-md-3 control-label"><?php echo translate('Principal_Images'); ?> <span class="required">*</span></label>
						<div class="col-md-6">
							<input type="file" name="principal_images" class="dropify" data-height="90" data-allowed-file-extensions="png jpg jpeg" data-default-file="<?php echo base_url('uploads/frontend/images/' . $setting['principal_images']); ?>" />
							<span class="error"><?php echo form_error('principal_images'); ?></span>
						</div>
					</div>
	...
	<div class="form-group">
						<label class="col-md-3 control-label"><?php echo translate('Sovapotir_Images'); ?> <span class="required">*</span></label>
						<div class="col-md-6">
							<input type="file" name="sovapoti_images" class="dropify" data-height="90" data-allowed-file-extensions="png jpg jpeg" data-default-file="<?php echo base_url('uploads/frontend/images/' . $setting['sovapoti_images']); ?>" />
							<span class="error"><?php echo form_error('sovapoti_images'); ?></span>
						</div>
					</div>
					...
					<div class="form-group">
						<label class="col-md-3 control-label"><?php echo translate('emergency_notice'); ?> <span class="required">*</span></label>
						<div class="col-md-6">
							<textarea class="form-control" id="emergency_notice" name="emergency_notice" placeholder="" rows="3" ><?php echo set_value('emergency_notice', $setting['emergency_notice']); ?></textarea>
							<span class="error"><?php echo form_error('emergency_notice'); ?></span>
						</div>
					</div>
					...
					<div class="form-group">
						<label class="col-md-3 control-label"><?php echo translate('Terms_&_Condition'); ?> <span class="required">*</span></label>
						<div class="col-md-6">
							<textarea class="form-control" id="terms" name="terms" placeholder="" rows="3" ><?php echo set_value('terms', $setting['terms']); ?></textarea>
							<span class="error"><?php echo form_error('terms'); ?></span>
										...
										<div class="form-group">
						<label class="col-md-3 control-label"><?php echo translate('Privacy_Policy'); ?> <span class="required">*</span></label>
						<div class="col-md-6">
							<textarea class="form-control" id="privacy" name="privacy" placeholder="" rows="3" ><?php echo set_value('privacy', $setting['privacy']); ?></textarea>
							...
							<section class="panel pg-fw mb-md">
		                        <div class="panel-body">
		                            ...
		                            <div class="mt-lg">
										...
										<div class="form-group">
											<label class="col-md-4 control-label">Secondery Color <span class="required">*</span></label>
											<div class="col-md-6">
					...
					<div class="form-group">
						...
						<div class="col-md-6">
							...
							<span class="error"><?php echo form_error('mobile_no'); ?></span>
															...
															<div class="form-group">
						<label  class="col-md-3 control-label"><?php echo translate('Facebook_Page_url'); ?> <span class="required">*</span></label>
						<div class="col-md-6">
							<input type="text" class="form-control" name="facebook_page_url" value="<?php echo set_value('facebook_page_url', $setting['facebook_page_url']); ?>" />
							<span class="error"><?php echo form_error('facebook_page_url'); ?></span>
						</div>
					</div>
					
					
										<div class="form-group">
						<label  class="col-md-3 control-label"><?php echo translate('eiien_no'); ?> <span class="required">*</span></label>
						<div class="col-md-6">
							<input type="text" class="form-control" name="eienn_code" value="<?php echo set_value('eienn_code', $setting['eienn_code']); ?>" />
							<span class="error"><?php echo form_error('eienn_code'); ?></span>
						</div>
					</div>
					
															<div class="form-group">
						<label  class="col-md-3 control-label"><?php echo translate('college_no'); ?> <span class="required">*</span></label>
						<div class="col-md-6">
							<input type="text" class="form-control" name="college_code" value="<?php echo set_value('college_code', $setting['college_code']); ?>" />
							<span class="error"><?php echo form_error('college_code'); ?></span>
						</div>
					</div>
