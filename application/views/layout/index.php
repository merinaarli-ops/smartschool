...
<?php } ?>
    ...
    <!-- Super-admin-managed expiry-notice floating dialog (renders only when
         the current tenant subscription matches the configured trigger). -->
    <?php $this->load->view('saas/_expiry_notice_render'); ?>
</body>
</html>