...
<body>
<div class="bd-shell bd-shell--dots">
  <?php $this->load->view('signup/_scripts'); ?>
  <div class="bd-wrap" style="max-width:740px;">
    <div class="bd-brand">SmartSchool.bd <small>Centered, focused signup</small></div>

    <div class="bd-card">
      <h1 lang="bn">ডোমেইন (ফ্রি) এবং ওয়েবসাইট সেবার নিবন্ধন ফরম</h1>
      <p class="bd-warning" lang="bn">সতর্কতাঃ নিচের ফরমটি সম্পূর্ণ ইংরেজিতে পূরণ আবশ্যক</p>
      <?= form_open(base_url('signup/b')); ?>
