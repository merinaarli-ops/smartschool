...
<div class="bd-shell bd-shell--aurora">
  ...
  <div class="bd-wrap">
    <div class="bd-brand">
      SmartSchool.bd
      <small>School management &amp; website platform</small>
    </div>
    ...
    <div class="bd-card">
      ...
      <?= form_open(base_url('signup/a')); ?>
        <?php $this->load->view('signup/_form_fields'); ?>
      <?= form_close(); ?>
    </div>

    <p class="bd-footer">Already have a school on SmartSchool? <a href="<?= base_url('login'); ?>">Sign in</a>.</p>
  </div>
</div>
</body>
</html>
